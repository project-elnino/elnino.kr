...
// TermsOfServicePage is a React component that displays the terms of service.
// This version uses single quotes for JSX attributes to comply with ESLint rules.
      ...
      <div className='bg-blue-700 pt-12 md:pt-16'>
        ...
        <header className='bg-blue-700 text-white'>
          <div className='container mx-auto px-4 max-w-4xl py-8'>
            ...
            <h1 className='text-3xl md:text-4xl font-bold text-white mb-2'>이용약관</h1>
      ...
      <main className='container mx-auto px-4 max-w-4xl py-12'>
        <div className='prose prose-gray max-w-none'>
          ...
          <section className='mb-12'>
            <h2 className='text-2xl font-semibold text-gray-900 mb-4 border-b pb-2'>제1조 목적</h2>
            <p className='text-gray-700 leading-relaxed'>
              본 이용약관은 “Elnino”(이하 &apos;사이트&apos;)의 서비스의 이용조건과 운영에 관한 제반 사항 규정을 목적으로 합니다.
            </p>
          </section>

          {/* Section 2: Definitions */}
          <section className='mb-12'>
            <h2 className='text-2xl font-semibold text-gray-900 mb-4 border-b pb-2'>제2조 용어의 정의</h2>
            <p className='text-gray-700 mb-4 leading-relaxed'>본 약관에서 사용되는 주요한 용어의 정의는 다음과 같습니다.</p>
            <ul className='list-none pl-0 text-gray-700 space-y-3'>
              <li><span className='font-semibold'>① 회원 :</span> 사이트의 약관에 동의하고 개인정보를 제공하여 회원등록을 한 자로서, 사이트와의 이용계약을 체결하고 사이트를 이용하는 이용자를 말합니다.</li>
              <li><span className='font-semibold'>② 이용계약 :</span> 사이트 이용과 관련하여 사이트와 회원간에 체결 하는 계약을 말합니다.</li>
              <li><span className='font-semibold'>③ 회원 아이디(이하 &apos;ID&apos;) :</span> 회원의 식별과 회원의 서비스 이용을 위하여 회원별로 부여하는 고유한 문자와 숫자의 조합을 말합니다.</li>
              <li><span className='font-semibold'>④ 비밀번호 :</span> 회원이 부여받은 ID와 일치된 회원임을 확인하고 회원의 권익 보호를 위하여 회원이 선정한 문자와 숫자의 조합을 말합니다.</li>
              <li><span className='font-semibold'>⑤ 운영자 :</span> 서비스에 홈페이지를 개설하여 운영하는 운영자를 말합니다.</li>
              <li><span className='font-semibold'>⑥ 해지 :</span> 회원이 이용계약을 해약하는 것을 말합니다.</li>
            </ul>
          </section>
          
          {/* Section 3: Rules outside the Terms */}
          <section className='mb-12'>
            <h2 className='text-2xl font-semibold text-gray-900 mb-4 border-b pb-2'>제3조 약관 외 준칙</h2>
            <p className='text-gray-700 leading-relaxed'>
          ...
          <section className='mb-12'>
            <h2 className='text-2xl font-semibold text-gray-900 mb-4 border-b pb-2'>제4조 이용계약 체결</h2>
            <p className='text-gray-700 mb-3 leading-relaxed'>
              ① 이용계약은 회원으로 등록하여 사이트를 이용하려는 자의 본 약관 내용에 대한 동의와 가입신청에 대하여 운영자의 이용승낙로 성립합니다.
            </p>
            <p className='text-gray-700 leading-relaxed'>
           ...
           {/* 제5조 */}
          <section className='mb-12'>
            <h2 className='text-2xl font-semibold text-gray-900 mb-4 border-b pb-2'>제5조 서비스 이용 신청</h2>
            <p className='text-gray-700 mb-3 leading-relaxed'>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4 border-b pb-2">제6조 개인정보처리방침</h2>
          ...
          {/* ... (The rest of the articles follow the same improved structure) ... */}
          
           {/* 제7조 */}
          <section className="mb-12">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4 border-b pb-2">제7조 운영자의 의무</h2>
            <p className="text-gray-700 mb-3 leading-relaxed">
          ...
          {/* 제8조 */}
          <section className="mb-12">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4 border-b pb-2">제8조 회원의 의무</h2>
             <p className="text-gray-700 mb-3 leading-relaxed">
          ...
          {/* 제9조 */}
          <section className="mb-12">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4 border-b pb-2">제9조 서비스 이용 시간</h2>
            <p className="text-gray-700 mb-3 leading-relaxed">
          ...
          {/* 제10조 */}
          <section className="mb-12">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4 border-b pb-2">제10조 서비스 이용 해지</h2>
            <p className="text-gray-700 mb-3 leading-relaxed">
          ...
          {/* 제11조 */}
          <section className="mb-12">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4 border-b pb-2">제11조 서비스 이용 제한</h2>
          ...
          {/* 제12조 */}
          <section className="mb-12">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4 border-b pb-2">제12조 게시물의 관리</h2>
            <div className="space-y-3 text-gray-700 leading-relaxed">
                <p>
          ...
          {/* 제13조 */}
          <section className="mb-12">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4 border-b pb-2">제13조 게시물의 보관</h2>
            <p className="text-gray-700 leading-relaxed">
          ...
          {/* 제14조 */}
          <section className="mb-12">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4 border-b pb-2">제14조 게시물에 대한 저작권</h2>
            <div className="space-y-3 text-gray-700 leading-relaxed">
                <p>
          ...
          {/* 제15조 */}
          <section className="mb-12">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4 border-b pb-2">제15조 손해배상</h2>
            <p className="text-gray-700 mb-3 leading-relaxed">
          ...
          {/* 제16조 */}
          <section className='mb-12'>
            <h2 className='text-2xl font-semibold text-gray-900 mb-4 border-b pb-2'>제16조 면책</h2>
            <div className='space-y-3 text-gray-700 leading-relaxed'>
                <p>
          ...
          <section className='mb-12'>
            <h2 className='text-2xl font-semibold text-gray-900 mb-4 border-b pb-2'>부칙</h2>
            <p className='text-gray-700 leading-relaxed'>
              이 약관은 2025년 5월 25일부터 시행합니다.
            </p>
          </section>
        </div>
